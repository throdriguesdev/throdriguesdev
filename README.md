...
<img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=24&pause=1000&color=CBA6F7&center=true&vCenter=true&width=720&lines=Platform+%2F+Infrastructure+Engineer;Observability+%C2%B7+FinOps+%C2%B7+GitOps;I+build+reliable%2C+cost-aware+cloud+systems" alt="typing banner" />
...
```text
       ___________          thiago@github
      |  _______  |         ──────────────────────────────────────────────
      | |       | |         role     Platform / Infrastructure Engineer
      | |  o o  | |         stack    AWS · GCP · Kubernetes · Terraform · Go
      | |   ^   | |         focus    Observability (LGTM) · FinOps · GitOps
